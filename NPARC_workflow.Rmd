...
nullRSS <- tppData %>% #filter(dataset == "Panobinostat") %>% #filter(uniqueID == "ABHD10_NA", dataset == "Panobinostat") %>%
...
<!-- Show the first rows: -->
<!-- ```{r inspect_alternative_rss} -->
<!-- alternativeRSS %>% head %>% kable() -->
<!-- ``` -->
...
<!-- ```{r, eval = FALSE, echo = FALSE} -->
<!-- # List all proteins for which the model fit did not converge: -->
<!-- alternativeRSS %>% filter(!isConverged) -->
<!-- ``` -->
...
<!-- Show the first rows: -->
<!-- ```{r} -->
<!-- alternativeRSSCollated %>% head %>% kable() -->
<!-- ``` -->
